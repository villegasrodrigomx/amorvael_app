...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function router() {
        ...
        const packageId = params.get('packageId'); // Usamos packageId para consistencia
        const purchaseId = params.get('purchaseId');

        // Ocultar modales si no se está abriendo uno nuevo
    ...
    function createCard(type, data) {
        ...
        if (type === 'category') {
            ...
            card.className = 'package-card'; // Usamos una clase distinta para diferenciar
