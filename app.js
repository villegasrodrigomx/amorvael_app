document.addEventListener('DOMContentLoaded', () => {
  ...
  function openPurchaseModal(pkg) {
    ...
    document.querySelector('#booking-modal .client-inputs').style.display = 'block';
    document.querySelector('#booking-modal #payment-options-section').style.display = 'none';
    document.querySelector('#booking-modal #payment-section').style.display = 'none';
    document.querySelector('#booking-modal #transfer-details').style.display = 'none';
