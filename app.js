document.addEventListener('DOMContentLoaded', () => {
  ...
  let allData = null; // Almacena los datos de la API para evitar llamadas repetidas
  let clientData = JSON.parse(sessionStorage.getItem('amorVaelClientData')) || null; // Carga los datos del cliente al iniciar
  ...
  function router() {
    ...
    console.log('Routing for:', window.location.search); // Log de depuración
  ...
  function renderView(templateId) {
    console.log(`Rendering view: ${templateId}`); // Log de depuración
